...
public class UserMedinotice2Activity extends Activity {
//用户指定药品购买
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_user_medinotice2);
	...
	btnBuy.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View arg0) {
			// TODO Auto-generated method stub
			//Toast.makeText(UserMedinotice2Activity.this, ".............！", Toast.LENGTH_LONG).show();
			String No=buyNumber.getText().toString();
			...
			if(_Mc>0&&_Mc>=_No)
			{
               ...
               db.execSQL("insert into Consumlist2 values(?,?,?,?,?,?)", new String[]{a, b, c, d, e, f});
				...
				Toast.makeText(UserMedinotice2Activity.this, "购买成功", Toast.LENGTH_LONG).show();
				Intent it = new Intent(UserMedinotice2Activity.this,UserMediActivity.class);  
                it.putExtras(it);
			...
			else
			{
				...
				Toast.makeText(UserMedinotice2Activity.this, "库存不足！", Toast.LENGTH_LONG).show();
			}
